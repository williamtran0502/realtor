...
export default function ListingItem({listing, id, onEdit, onDelete}) {
  return (
    <li className='relative bg-white flex flex-col justify-between items-center shadow-md hover:shadow-xl rounded-md overflow-hidden transition ease-in-out duration-150 m-[10px]'>
        ...
        {onEdit && (
            <MdEdit className='absolute bottom-2 right-7 h-4 cursor-pointer text-red-500' onClick={() => onEdit(listing.id)}/>
        )}
