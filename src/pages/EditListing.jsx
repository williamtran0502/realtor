    ...
    <main className='max-w-md px-2 mx-auto'>
        ...
        <form onSubmit={onSubmit}>
            ...
            <div className='flex'>
                ...
                value="rent" 
                onClick={onChange}  
                className={`px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg transition ease-in-out duration-150 w-full 
                ${type === "sell" 
                ? "bg-white text-black" 
                : "bg-slate-600 text-white"
                }`}>
